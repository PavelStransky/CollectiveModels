...
namespace PavelStransky.Expression.Functions {
    ...
    /// </summary>
    public class LHOQGCMC : FunctionDefinition {
        ...
        protected override object Evaluate(int depth, object item, ArrayList arguments) {
            if(item is double) {
                ...
                LHOQuantumGCMC qgcm = new LHOQuantumGCMC((double)item, b, c, k, a0, hbar);
                return qgcm;
            }
        ...
        private const string help = "Vytvoøí LHOQuantumGCMC tøídu pro dané parametry";
