...
namespace PavelStransky.Systems {
    public class ClassicalDicke : Dicke, IDynamicalSystem {
        ...
        public ClassicalDicke(double omega0, double omega, double gamma, double j, double delta, double xi, double kappa, double mu) : base(omega0, omega, gamma, j, delta, xi, kappa, mu) { }
