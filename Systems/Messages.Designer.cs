...
namespace PavelStransky.Systems {
    ...
    internal class Messages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The power of the principal term in the Creagh-Whelan potential could be only 2 or 4, not {0}..
        /// </summary>
        internal static string EMBadPower {
            get {
                return ResourceManager.GetString("EMBadPower", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Diagonalization LAPACK.zgeev.
        /// </summary>
        internal static string MDiagonalizationZGEEV {
            get {
                return ResourceManager.GetString("MDiagonalizationZGEEV", resourceCulture);
            }
        }
