...
namespace PavelStransky.Expression.Functions.Def {
    ...
    public class LevelDensity : Fnc {
        ...
        protected override void CreateParameters() {
            this.SetNumParams(3);
            this.SetParam(0, true, true, false, Messages.PQuantumSystem, Messages.PQuantumSystemDescription, null, typeof(QuantumCW), typeof(PT3), typeof(QuantumDicke), typeof(IntrinsicIBM));
        ...
        protected override object EvaluateFn(Guider guider, ArrayList arguments) {
            ...
            if(arguments[0] is QuantumCW)
                ...
                return (arguments[0] as QuantumDicke).LevelDensity(e, step);
            else if(arguments[0] is IntrinsicIBM)
                return (arguments[0] as IntrinsicIBM).LevelDensity(e, step, guider);
