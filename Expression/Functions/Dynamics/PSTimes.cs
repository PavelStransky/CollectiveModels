...
namespace PavelStransky.Expression.Functions.Def {
    ...
    public class PSTimes: Poincare {
        ...
        protected override object Compute(PoincareSection ps, Vector plane, int i1, int i2, Vector ic, int numPoints, bool oneOrientation) {
            return ps.SectionTimes(plane, i1, i2, ic, numPoints, oneOrientation);
        }
    }
}