...
namespace PavelStransky.Systems {
    public class ClassicalDickeC : Dicke, IDynamicalSystem {
        ...
        public ClassicalDickeC(double omega0, double omega, double gamma, double j, double delta, double xi, double kappa, double mu) : base(omega0, omega, gamma, j, delta, xi, kappa, mu) { }
