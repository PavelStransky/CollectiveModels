...
namespace PavelStransky.Expression {
    ...
    public class Assignment: Atom {
        ...
        public Assignment(Context context, string expression, Atom parent)
            : this(context, expression, parent, null) {
        }
        ...
        public Assignment(Context context, string expression, Atom parent, IOutputWriter writer)
        ...
        public override object Evaluate() {
            ...
            object result = EvaluateAtomObject(this.context, this.rightSide);
            if(result != null)
                return this.context.SetVariable(this.name, result, this);
            else
