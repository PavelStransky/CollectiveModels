...
namespace PavelStransky.GCM {
    ...
    /// </summary>
    public class LHOQuantumGCMRALO: LHOQuantumGCM {
        // Indexy báze
        protected LHOPolarIndex index;
        /// <summary>
        /// Prázdný konstruktor
        /// </summary>
        protected LHOQuantumGCMRALO() { }
        ...
        public LHOQuantumGCMRALO(double a, double b, double c, double k, double a0)
            : base(a, b, c, k, a0) { }
        ...
        public LHOQuantumGCMRALO(double a, double b, double c, double k, double a0, double hbar)
        ...
        public LHOQuantumGCMRALO(Core.Import import) : base(import) { }
        #endregion
    }
}