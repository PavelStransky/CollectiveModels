...
namespace PavelStransky.Expression.Functions {
    ...
    /// </summary>
    public class CGCMJ: FunctionDefinition {
        ...
        protected override object Evaluate(int depth, object item, ArrayList arguments) {
            if(item is double) {
                ...
                return new ClassicalGCMJ((double)item, b, c, k);
            }
        ...
        private const string help = "Vytvoøí GCM tøídu s nenulovým úhlovým momentem pro dané parametry";
